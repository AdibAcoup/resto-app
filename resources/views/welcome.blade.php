<x-guest-layout>
    ...
    <section class="mt-8 bg-white">
        <div class="mt-4 text-center">
            ...
            <h2 class="text-3xl mt-3 font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">
    ...
    <section class="pt-4 pb-12 bg-gray-800">
        ...
        <div class="container mx-auto grid gap-16 px-6 sm:gap-16 md:gap-10 lg:grid-cols-3">
