                            ...
                            <form method="POST" action="{{ route('reservations.store.step.two') }}">
                                ...
                                <div class="sm:col-span-6 pt-5">
                                    ...
                                    <div class="mt-1">
                                        ...
                                        @else 
                                            <div class="mt-2 text-sm text-red-500">No tables available for guest {{$reservation->guest_number}}</div>                                            
                                        @endif              
                                    </div>
                                    @error('table_id')
                                ...
                                <div class="mt-6 flex justify-between">
                                    ...
                                    <button type="submit"
                                        class="px-4 disabled:opacity-50 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white"
