                ...
                <div class="space-y-8 divide-y divide-gray-200 sm:w-full md:w-full lg:w-full xl:w-1/2 mt-10">
                    <form  method="POST" action="{{ route('admin.menus.update', $menu->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="sm:col-span-6 pt-6">
                            ...
                            <div>
                                <img class="w-32 h-32 rounded" src="{{ Storage::url($menu->image) }}">
                            </div>
                            <div class="mt-3">
                                <input type="file" id="image" name="image"
                                    class="shadow-sm focus:ring-indigo-500 appearance-none bg-white border py-2 px-3 text-base leading-normal transition duration-150 ease-in-out focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md @error('image') border-red-400 @enderror" />
                            </div>   
                            @error('image')
                                <div class="text-sm text-red-400">{{ $message }}</div>
                            @enderror                        
                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div class="mt-1">
                                <select id="categories" name="categories[]" class="shadow-sm focus:ring-indigo-500 appearance-none bg-white border py-2 px-3 text-base leading-normal transition duration-150 ease-in-out focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md"
                                    multiple>
